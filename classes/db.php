...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "hrmanage_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "4 share", "varname" => "hrmanage_at_localhost__tbl4_share", "altvarname" => "tbl4_share", "connId" => "hrmanage_at_localhost", "schema" => "", "connName" => "hrmanage at localhost");
			$dalTables[$conn->connId][] = array("name" => "hostels", "varname" => "hrmanage_at_localhost__hostels", "altvarname" => "hostels", "connId" => "hrmanage_at_localhost", "schema" => "", "connName" => "hrmanage at localhost");
			$dalTables[$conn->connId][] = array("name" => "notice", "varname" => "hrmanage_at_localhost__notice", "altvarname" => "notice", "connId" => "hrmanage_at_localhost", "schema" => "", "connName" => "hrmanage at localhost");
			$dalTables[$conn->connId][] = array("name" => "outpass", "varname" => "hrmanage_at_localhost__outpass", "altvarname" => "outpass", "connId" => "hrmanage_at_localhost", "schema" => "", "connName" => "hrmanage at localhost");
			$dalTables[$conn->connId][] = array("name" => "studentlist", "varname" => "hrmanage_at_localhost__studentlist", "altvarname" => "studentlist", "connId" => "hrmanage_at_localhost", "schema" => "", "connName" => "hrmanage at localhost");
			$dalTables[$conn->connId][] = array("name" => "user", "varname" => "hrmanage_at_localhost__user", "altvarname" => "user", "connId" => "hrmanage_at_localhost", "schema" => "", "connName" => "hrmanage at localhost");
			$dalTables[$conn->connId][] = array("name" => "warden", "varname" => "hrmanage_at_localhost__warden", "altvarname" => "warden", "connId" => "hrmanage_at_localhost", "schema" => "", "connName" => "hrmanage at localhost");
		}
	}
