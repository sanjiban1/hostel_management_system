...
function fillProjectEntites()
{
	...
	$projectEntities[ "studentlist" ] = array( "url" => "studentlist", "type" => 0 );
	$projectEntitiesReverse[ "studentlist" ] = "studentlist";
	$projectEntities[ "hostels" ] = array( "url" => "hostels", "type" => 0 );
	$projectEntitiesReverse[ "hostels" ] = "hostels";
	$projectEntities[ "warden" ] = array( "url" => "warden", "type" => 0 );
	$projectEntitiesReverse[ "warden" ] = "warden";
	...
	$projectEntities[ "studentlist Report" ] = array( "url" => "studentlist_report", "type" => 2 );
	$projectEntitiesReverse[ "studentlist_report" ] = "studentlist Report";
	$projectEntities[ "studentlist Chart" ] = array( "url" => "studentlist_chart", "type" => 3 );
	$projectEntitiesReverse[ "studentlist_chart" ] = "studentlist Chart";
	$projectEntities[ "outpass" ] = array( "url" => "outpass", "type" => 0 );
	$projectEntitiesReverse[ "outpass" ] = "outpass";
}
