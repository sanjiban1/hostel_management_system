...
class ConnectionManager
{
	...
	{
		return $this->byId( "hrmanage_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "hrmanage_at_localhost";
		$data["connName"] = "hrmanage at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;hrmanage;;1"; //currently unused

		$this->_connectionsIdByName["hrmanage at localhost"] = "hrmanage_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "hrmanage";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=hrmanage;OPTION=3";
		// encription set
		...
		$connectionsData["hrmanage_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["user"] = "hrmanage_at_localhost";
		$connectionsIds["studentlist"] = "hrmanage_at_localhost";
		$connectionsIds["hostels"] = "hrmanage_at_localhost";
		$connectionsIds["warden"] = "hrmanage_at_localhost";
		$connectionsIds["notice"] = "hrmanage_at_localhost";
		$connectionsIds["studentlist Report"] = "hrmanage_at_localhost";
		$connectionsIds["studentlist Chart"] = "hrmanage_at_localhost";
		$connectionsIds["outpass"] = "hrmanage_at_localhost";
