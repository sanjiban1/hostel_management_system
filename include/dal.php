...
class tDAL
{
	var $tblhrmanage_at_localhost__tbl4_share;
	var $tblhrmanage_at_localhost__hostels;
	var $tblhrmanage_at_localhost__notice;
	var $tblhrmanage_at_localhost__outpass;
	var $tblhrmanage_at_localhost__studentlist;
	var $tblhrmanage_at_localhost__user;
	var $tblhrmanage_at_localhost__warden;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "4 share", "varname" => "hrmanage_at_localhost__tbl4_share", "altvarname" => "tbl4_share", "connId" => "hrmanage_at_localhost", "schema" => "", "connName" => "hrmanage at localhost");
		$this->lstTables[] = array("name" => "hostels", "varname" => "hrmanage_at_localhost__hostels", "altvarname" => "hostels", "connId" => "hrmanage_at_localhost", "schema" => "", "connName" => "hrmanage at localhost");
		$this->lstTables[] = array("name" => "notice", "varname" => "hrmanage_at_localhost__notice", "altvarname" => "notice", "connId" => "hrmanage_at_localhost", "schema" => "", "connName" => "hrmanage at localhost");
		$this->lstTables[] = array("name" => "outpass", "varname" => "hrmanage_at_localhost__outpass", "altvarname" => "outpass", "connId" => "hrmanage_at_localhost", "schema" => "", "connName" => "hrmanage at localhost");
		$this->lstTables[] = array("name" => "studentlist", "varname" => "hrmanage_at_localhost__studentlist", "altvarname" => "studentlist", "connId" => "hrmanage_at_localhost", "schema" => "", "connName" => "hrmanage at localhost");
		$this->lstTables[] = array("name" => "user", "varname" => "hrmanage_at_localhost__user", "altvarname" => "user", "connId" => "hrmanage_at_localhost", "schema" => "", "connName" => "hrmanage at localhost");
		$this->lstTables[] = array("name" => "warden", "varname" => "hrmanage_at_localhost__warden", "altvarname" => "warden", "connId" => "hrmanage_at_localhost", "schema" => "", "connName" => "hrmanage at localhost");
	}
