...
$tdatauser[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdatauser[".originalPagesByType"] = $tdatauser[".pagesByType"];
$tdatauser[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdatauser[".originalPages"] = $tdatauser[".pages"];
$tdatauser[".defaultPages"] = my_json_decode( "{\"add\":\"add\",\"edit\":\"edit\",\"export\":\"export\",\"import\":\"import\",\"list\":\"list\",\"masterlist\":\"masterlist\",\"masterprint\":\"masterprint\",\"print\":\"print\",\"search\":\"search\",\"view\":\"view\"}" );
...
if(mlang_getcurrentlang()=="English")
{
	...
	$placeHoldersuser["English"]["fullname"] = "";
	$fieldLabelsuser["English"]["email"] = "Email";
	$fieldToolTipsuser["English"]["email"] = "";
	$placeHoldersuser["English"]["email"] = "";
	$fieldLabelsuser["English"]["mob"] = "Mob";
	$fieldToolTipsuser["English"]["mob"] = "";
	$placeHoldersuser["English"]["mob"] = "";
...
$tdatauser[".connId"] = "hrmanage_at_localhost";
...
$tdatauser[".googleLikeFields"][] = "mob";
...
$tdatauser[".sqlHead"] = "SELECT id,  	username,  	fullname,  	email,  	mob,  	password";
...
//end of Filters settings
	...
	$tdatauser["fullname"] = $fdata;
		$tdatauser[".searchableFields"][] = "fullname";
//	email
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 4;
...
//	Custom field settings
	...
	$fdata["GoodName"] = "mob";
	$fdata["ownerTable"] = "user";
	$fdata["Label"] = GetFieldLabel("user","mob");
	$fdata["FieldType"] = 3;
...
//end of Filters settings
	...
	$tdatauser["mob"] = $fdata;
		$tdatauser[".searchableFields"][] = "mob";
//	password
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 6;
...
$proto0["m_strFieldList"] = "id,  	username,  	fullname,  	email,  	mob,  	password";
